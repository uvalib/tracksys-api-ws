...
<xsl:stylesheet xmlns:mods="http://www.loc.gov/mods/v3"
  ...
  xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="mods xs"
  version="2.0">

  <!-- This stylesheet is functionally the same as mods2uvaMAP.xsl. It was 
    generated by resolveStylesheetIncludes.xsl (v. 0.1) 2023-11-15T13:02 -->
  ...
  <xsl:variable name="marcCarrierMap">
    <carrier rdaType="aperture card" rdaCode="ha">aperture card</carrier>
    <carrier rdaType="audio belt" rdaCode="sb">audio belt</carrier>
    <carrier rdaType="audio cartridge" rdaCode="sg">audio cartridge</carrier>
    <carrier rdaType="audio cartridge" rdaCode="sg">sound cartridge</carrier>
    <carrier rdaType="audio cylinder" rdaCode="se">audio cylinder</carrier>
    <carrier rdaType="audio cylinder" rdaCode="se">cylinder</carrier>
    <carrier rdaType="audio disc" rdaCode="sd">audio disc</carrier>
    <carrier rdaType="audio disc" rdaCode="sd">sound disc</carrier>
    <carrier rdaType="audio roll" rdaCode="sq">audio roll</carrier>
    <carrier rdaType="audio wire reel" rdaCode="sw">audio wire reel</carrier>
    <carrier rdaType="audio wire reel" rdaCode="sw">audio wire recording</carrier>
    <carrier rdaType="audio wire reel" rdaCode="sw">wire recording</carrier>
    <carrier rdaType="audiocassette" rdaCode="ss">audiocassette</carrier>
    <carrier rdaType="audiocassette" rdaCode="ss">sound cassette</carrier>
    <carrier rdaType="audiotape reel" rdaCode="st">audiotape reel</carrier>
    <carrier rdaType="card" rdaCode="no">activity card</carrier>
    <carrier rdaType="card" rdaCode="no">card</carrier>
    <carrier rdaType="card" rdaCode="no">flash card</carrier>
    <carrier rdaType="card" rdaCode="no">postcard</carrier>
    <carrier rdaType="computer card" rdaCode="ck">computer card</carrier>
    <carrier rdaType="computer chip cartridge" rdaCode="cb">computer chip
      cartridge</carrier>
    <carrier rdaType="computer disc cartridge" rdaCode="ce">computer disc
      cartridge</carrier>
    <carrier rdaType="computer disc" rdaCode="cd">computer disc</carrier>
    <carrier rdaType="computer disc" rdaCode="cd">magnetic disk</carrier>
    <carrier rdaType="computer disc" rdaCode="cd">magneto-optical disc</carrier>
    <carrier rdaType="computer disc" rdaCode="cd">optical disc</carrier>
    <carrier rdaType="computer tape cartridge" rdaCode="ca">computer tape
      cartridge</carrier>
    <carrier rdaType="computer tape cartridge" rdaCode="ca">tape cartridge</carrier>
    <carrier rdaType="computer tape cassette" rdaCode="cf">computer tape
      cassette</carrier>
    <carrier rdaType="computer tape cassette" rdaCode="cf">tape cassette</carrier>
    <carrier rdaType="computer tape reel" rdaCode="ch">computer tape reel</carrier>
    <carrier rdaType="computer tape reel" rdaCode="ch">tape reel</carrier>
    <carrier rdaType="film cartridge" rdaCode="mc">film cartridge</carrier>
    <carrier rdaType="film cassette" rdaCode="mf">film cassette</carrier>
    <carrier rdaType="film reel" rdaCode="mr">film reel</carrier>
    <carrier rdaType="film roll" rdaCode="mo">film roll</carrier>
    <carrier rdaType="filmslip" rdaCode="gd">filmslip</carrier>
    <carrier rdaType="filmstrip cartridge" rdaCode="gc">filmstrip cartridge</carrier>
    <carrier rdaType="filmstrip" rdaCode="gf">filmstrip</carrier>
    <carrier rdaType="filmstrip" rdaCode="gf">other filmstrip type</carrier>
    <carrier rdaType="flipchart" rdaCode="nn">flipchart</carrier>
    <carrier rdaType="microfiche cassette" rdaCode="hf">microfiche cassette</carrier>
    <carrier rdaType="microfiche" rdaCode="he">microfiche</carrier>
    <carrier rdaType="microfilm cartridge" rdaCode="hb">microfilm cartridge</carrier>
    <carrier rdaType="microfilm cassette" rdaCode="hc">microfilm cassette</carrier>
    <carrier rdaType="microfilm reel" rdaCode="hd">microfilm reel</carrier>
    <carrier rdaType="microfilm roll" rdaCode="hj">microfilm roll</carrier>
    <carrier rdaType="microfilm slip" rdaCode="hh">microfilm slip</carrier>
    <carrier rdaType="microopaque" rdaCode="hg">microopaque</carrier>
    <carrier rdaType="microscope slide" rdaCode="pp">microscope slide</carrier>
    <carrier rdaType="object" rdaCode="nr">celestial globe</carrier>
    <carrier rdaType="object" rdaCode="nr">diorama</carrier>
    <carrier rdaType="object" rdaCode="nr">earth moon globe</carrier>
    <carrier rdaType="object" rdaCode="nr">globe</carrier>
    <carrier rdaType="object" rdaCode="nr">model</carrier>
    <carrier rdaType="object" rdaCode="nr">object</carrier>
    <carrier rdaType="object" rdaCode="nr">planetary or lunar globe</carrier>
    <carrier rdaType="object" rdaCode="nr">realia</carrier>
    <carrier rdaType="object" rdaCode="nr">terrestrial globe</carrier>
    <carrier rdaType="online resource" rdaCode="cr">online resource</carrier>
    <carrier rdaType="online resource" rdaCode="cr">remote</carrier>
    <carrier rdaType="other audio carrier" rdaCode="sz">other audio carrier</carrier>
    <carrier rdaType="other audio carrier" rdaCode="sz">sound recording</carrier>
    <carrier rdaType="other computer carrier" rdaCode="cz">electronic resource</carrier>
    <carrier rdaType="other computer carrier" rdaCode="cz">electronic</carrier>
    <carrier rdaType="other computer carrier" rdaCode="cz">other computer
      carrier</carrier>
    <carrier rdaType="other microform carrier" rdaCode="hz">other microform
      carrier</carrier>
    <carrier rdaType="other microscopic carrier" rdaCode="pz">other microscopic
      carrier</carrier>
    <carrier rdaType="other projected carrier" rdaCode="mz">motion picture</carrier>
    <carrier rdaType="other projected carrier" rdaCode="mz">other projected
      carrier</carrier>
    <carrier rdaType="other stereographic carrier" rdaCode="ez">other stereographic
      carrier</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">art original</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">art reproduction</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">braille</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">chart</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">collage</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">diagram</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">drawing</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">game</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">graphic</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">icon</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">large print</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">map</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">moon</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">non-projected
      graphic</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">nonprojected
      graphic</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">other unmediated
      carrier</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">painting</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">photograph</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">photomechanical
      print</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">photonegative</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">photoprint</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">picture</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">print</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">profile</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">regular print</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">remote-sensing
      image</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">section</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">study print</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">tactile, with no writing
      system</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">technical drawing</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">text in looseleaf
      binder</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">toy</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">view</carrier>
    <carrier rdaType="other video carrier" rdaCode="vz">other video carrier</carrier>
    <carrier rdaType="overhead transparency" rdaCode="gt">overhead transparency</carrier>
    <carrier rdaType="overhead transparency" rdaCode="gt">transparency</carrier>
    <carrier rdaType="roll" rdaCode="na">roll</carrier>
    <carrier rdaType="sheet" rdaCode="nb">radiograph</carrier>
    <carrier rdaType="sheet" rdaCode="nb">sheet</carrier>
    <carrier rdaType="slide" rdaCode="gs">slide</carrier>
    <carrier rdaType="sound track reel" rdaCode="si">sound-track reel</carrier>
    <carrier rdaType="sound track reel" rdaCode="si">sound-tape reel</carrier>
    <carrier rdaType="sound track reel" rdaCode="si">sound-track film</carrier>
    <carrier rdaType="sound-track reel" rdaCode="si">sound-track reel</carrier>
    <carrier rdaType="stereograph card" rdaCode="eh">stereograph card</carrier>
    <carrier rdaType="stereograph disc" rdaCode="es">stereograph disc</carrier>
    <carrier rdaType="unspecified" rdaCode="zu">kit</carrier>
    <carrier rdaType="unspecified" rdaCode="zu">microform</carrier>
    <!-- Erroneous value of "text" is mapped to unspecified -->
    <carrier rdaType="unspecified" rdaCode="zu">text</carrier>
    <carrier rdaType="unspecified" rdaCode="zu">unspecified</carrier>
    <carrier rdaType="unspecified" rdaCode="zu">videorecording</carrier>
    <carrier rdaType="video cartridge" rdaCode="vc">video cartridge</carrier>
    <carrier rdaType="video cartridge" rdaCode="vc">videocartridge</carrier>
    <carrier rdaType="videocassette" rdaCode="vf">videocassette</carrier>
    <carrier rdaType="videodisc" rdaCode="vd">videodisc</carrier>
    <carrier rdaType="videotape reel" rdaCode="vr">videoreel</carrier>
    <carrier rdaType="videotape reel" rdaCode="vr">videotape reel</carrier>
    <carrier rdaType="volume" rdaCode="nc">atlas</carrier>
    <carrier rdaType="volume" rdaCode="nc">volume</carrier>
    <!-- Translate Dutch/German to English -->
    <carrier rdaType="volume" rdaCode="nc">band</carrier>
    <!-- Translate RDA CURIE (Compressed URI) to English term -->
    <carrier rdaType="aperture card" rdaCode="ha">rdact:1021</carrier>
    <carrier rdaType="audio belt" rdaCode="sb">rdact:1070</carrier>
    <carrier rdaType="audio cartridge" rdaCode="sg">rdact:1002</carrier>
    <carrier rdaType="audio cylinder" rdaCode="se">rdact:1003</carrier>
    <carrier rdaType="audio disc" rdaCode="sd">rdact:1004</carrier>
    <carrier rdaType="audio roll" rdaCode="sq">rdact:1006</carrier>
    <carrier rdaType="audio wire reel" rdaCode="sw">rdact:1071</carrier>
    <carrier rdaType="audiocassette" rdaCode="ss">rdact:1007</carrier>
    <carrier rdaType="audiotape reel" rdaCode="st">rdact:1008</carrier>
    <carrier rdaType="card" rdaCode="no">rdact:1045</carrier>
    <carrier rdaType="computer card" rdaCode="ck">rdact:1011</carrier>
    <carrier rdaType="computer chip cartridge" rdaCode="cb">rdact:1012</carrier>
    <carrier rdaType="computer disc" rdaCode="cd">rdact:1013</carrier>
    <carrier rdaType="computer disc cartridge" rdaCode="ce">rdact:1014</carrier>
    <carrier rdaType="computer tape cartridge" rdaCode="ca">rdact:1015</carrier>
    <carrier rdaType="computer tape cassette" rdaCode="cf">rdact:1016</carrier>
    <carrier rdaType="computer tape reel" rdaCode="ch">rdact:1017</carrier>
    <carrier rdaType="film cartridge" rdaCode="mc">rdact:1032</carrier>
    <carrier rdaType="film cassette" rdaCode="mf">rdact:1033</carrier>
    <carrier rdaType="film reel" rdaCode="mr">rdact:1034</carrier>
    <carrier rdaType="film roll" rdaCode="mo">rdact:1069</carrier>
    <carrier rdaType="filmslip" rdaCode="gd">rdact:1035</carrier>
    <carrier rdaType="filmstrip" rdaCode="gf">rdact:1036</carrier>
    <carrier rdaType="filmstrip cartridge" rdaCode="gc">rdact:1037</carrier>
    <carrier rdaType="flipchart" rdaCode="nn">rdact:1046</carrier>
    <carrier rdaType="microfiche" rdaCode="he">rdact:1022</carrier>
    <carrier rdaType="microfiche cassette" rdaCode="hf">rdact:1023</carrier>
    <carrier rdaType="microfilm cartridge" rdaCode="hb">rdact:1024</carrier>
    <carrier rdaType="microfilm cassette" rdaCode="hc">rdact:1025</carrier>
    <carrier rdaType="microfilm reel" rdaCode="hd">rdact:1026</carrier>
    <carrier rdaType="microfilm roll" rdaCode="hj">rdact:1056</carrier>
    <carrier rdaType="microfilm slip" rdaCode="hh">rdact:1027</carrier>
    <carrier rdaType="microopaque" rdaCode="hg">rdact:1028</carrier>
    <carrier rdaType="microscope slide" rdaCode="pp">rdact:1030</carrier>
    <carrier rdaType="object" rdaCode="nr">rdact:1059</carrier>
    <carrier rdaType="online resource" rdaCode="cr">rdact:1018</carrier>
    <carrier rdaType="overhead transparency" rdaCode="gt">rdact:1039</carrier>
    <carrier rdaType="roll" rdaCode="na">rdact:1047</carrier>
    <carrier rdaType="sheet" rdaCode="nb">rdact:1048</carrier>
    <carrier rdaType="slide" rdaCode="gs">rdact:1040</carrier>
    <carrier rdaType="sound-track reel" rdaCode="si">rdact:1005</carrier>
    <carrier rdaType="stereograph card" rdaCode="eh">rdact:1042</carrier>
    <carrier rdaType="stereograph disc" rdaCode="es">rdact:1043</carrier>
    <carrier rdaType="video cartridge" rdaCode="vc">rdact:1051</carrier>
    <carrier rdaType="videocassette" rdaCode="vf">rdact:1052</carrier>
    <carrier rdaType="videodisc" rdaCode="vd">rdact:1060</carrier>
    <carrier rdaType="videotape reel" rdaCode="vr">rdact:1053</carrier>
    <carrier rdaType="volume" rdaCode="nc">rdact:1049</carrier>
    <carrier rdaType="other audio carrier" rdaCode="sz">rdact:1001</carrier>
    <carrier rdaType="other computer carrier" rdaCode="cz">rdact:1010</carrier>
    <carrier rdaType="other microform carrier" rdaCode="hz">rdact:1020</carrier>
    <carrier rdaType="other microscopic carrier" rdaCode="pz">rdact:1029</carrier>
    <carrier rdaType="other projected carrier" rdaCode="mz">rdact:1031</carrier>
    <carrier rdaType="other stereographic carrier" rdaCode="ez">rdact:1041</carrier>
    <carrier rdaType="other unmediated carrier" rdaCode="nz">rdact:1044</carrier>
    <carrier rdaType="other video carrier" rdaCode="vz">rdact:1050</carrier>
  </xsl:variable>

  <!-- <xsl:import href="marcMediaMap.xsl"/> -->
  <xsl:variable name="marcMediaMap">
    <media rdaType="audio" rdaCode="s">audio</media>
    <media rdaType="audio" rdaCode="s">sound recording</media>
    <media rdaType="computer" rdaCode="c">computer</media>
    <media rdaType="computer" rdaCode="c">electronic resource</media>
    <media rdaType="computer" rdaCode="c">electronic</media>
    <media rdaType="computer" rdaCode="c">remote</media>
    <media rdaType="microform" rdaCode="h">microfiche</media>
    <media rdaType="microform" rdaCode="h">&gt;microfilm</media>
    <media rdaType="microform" rdaCode="h">&gt;microform</media>
    <media rdaType="microscopic" rdaCode="p">microscope slide</media>
    <media rdaType="microscopic" rdaCode="p">microscopic</media>
    <media rdaType="projected" rdaCode="g">filmstrip</media>
    <media rdaType="projected" rdaCode="g">motion picture</media>
    <media rdaType="projected" rdaCode="g">projected graphic</media>
    <media rdaType="projected" rdaCode="g">projected</media>
    <media rdaType="projected" rdaCode="g">slide</media>
    <media rdaType="projected" rdaCode="g">transparency</media>
    <media rdaType="stereographic" rdaCode="e">stereographic</media>
    <media rdaType="unmediated" rdaCode="n">activity card</media>
    <media rdaType="unmediated" rdaCode="n">art original</media>
    <media rdaType="unmediated" rdaCode="n">art reproduction</media>
    <media rdaType="unmediated" rdaCode="n">braille</media>
    <media rdaType="unmediated" rdaCode="n">cartographic material</media>
    <media rdaType="unmediated" rdaCode="n">chart</media>
    <media rdaType="unmediated" rdaCode="n">diorama</media>
    <media rdaType="unmediated" rdaCode="n">flash card</media>
    <media rdaType="unmediated" rdaCode="n">globe</media>
    <media rdaType="unmediated" rdaCode="n">large print</media>
    <media rdaType="unmediated" rdaCode="n">manuscript</media>
    <media rdaType="unmediated" rdaCode="n">map</media>
    <media rdaType="unmediated" rdaCode="n">model</media>
    <media rdaType="unmediated" rdaCode="n">music</media>
    <media rdaType="unmediated" rdaCode="n">nonprojected graphic</media>
    <media rdaType="unmediated" rdaCode="n">non-projected graphic</media>
    <media rdaType="unmediated" rdaCode="n">notated music</media>
    <media rdaType="unmediated" rdaCode="n">picture</media>
    <media rdaType="unmediated" rdaCode="n">print</media>
    <media rdaType="unmediated" rdaCode="n">realia</media>
    <media rdaType="unmediated" rdaCode="n">remote sensing image</media>
    <media rdaType="unmediated" rdaCode="n">tactile material</media>
    <media rdaType="unmediated" rdaCode="n">technical drawing</media>
    <media rdaType="unmediated" rdaCode="n">text</media>
    <media rdaType="unmediated" rdaCode="n">toy</media>
    <media rdaType="unmediated" rdaCode="n">unmediated</media>
    <media rdaType="unspecifed" rdaCode="z">unspecified</media>
    <media rdaType="unspecified" rdaCode="z">game</media>
    <media rdaType="unspecified" rdaCode="z">kit</media>
    <media rdaType="video" rdaCode="v">video</media>
    <media rdaType="video" rdaCode="v">videodisc</media>
    <media rdaType="video" rdaCode="v">videorecording</media>
    <!-- Translate Dutch to English -->
    <media rdaType="microform" rdaCode="h">microvorm</media>
    <media rdaType="microscopic" rdaCode="p">microscopisch</media>
    <media rdaType="projected" rdaCode="g">geprojecteerd</media>
    <media rdaType="stereographic" rdaCode="e">stereografisch</media>
    <media rdaType="unmediated" rdaCode="n">zonder medium</media>
    <!-- Translate French to English -->
    <media rdaType="computer" rdaCode="c">informatique</media>
    <media rdaType="microform" rdaCode="h">microforme</media>
    <media rdaType="microscopic" rdaCode="p">microscopique</media>
    <media rdaType="projected" rdaCode="g">projeté</media>
    <media rdaType="stereographic" rdaCode="e">stéréoscopique</media>
    <media rdaType="unmediated" rdaCode="n">sans médiation</media>
    <media rdaType="video" rdaCode="v">vidéo</media>
    <!-- Translate German to English -->
    <media rdaType="computer" rdaCode="c">computermedien</media>
    <media rdaType="microform" rdaCode="h">mikroform</media>
    <media rdaType="microscopic" rdaCode="p">mikroskopisch</media>
    <media rdaType="projected" rdaCode="g">projizierbar</media>
    <media rdaType="stereographic" rdaCode="e">stereografisch</media>
    <media rdaType="unmediated" rdaCode="n">ohne hilfsmittel zu benutzen</media>
    <!-- Translate Italian to English -->
    <media rdaType="computer" rdaCode="c">elettronico</media>
    <media rdaType="microform" rdaCode="h">microformati</media>
    <media rdaType="microscopic" rdaCode="p">microscopico</media>
    <media rdaType="projected" rdaCode="g">proiettato</media>
    <media rdaType="stereographic" rdaCode="e">stereografico</media>
    <media rdaType="unmediated" rdaCode="n">privo di media</media>
    <!-- Translate Spanish to English -->
    <media rdaType="computer" rdaCode="c">computadora</media>
    <media rdaType="microform" rdaCode="h">microformas</media>
    <media rdaType="microscopic" rdaCode="p">microscópicos</media>
    <media rdaType="projected" rdaCode="g">proyectados</media>
    <media rdaType="stereographic" rdaCode="e">estereográficos</media>
    <media rdaType="unmediated" rdaCode="n">sin mediación</media>
    <!-- Translate RDA CURIE (Compressed URI) to English term -->
    <media rdaType="audio" rdaCode="s">rdamt:1001</media>
    <media rdaType="computer" rdaCode="c">rdamt:1003</media>
    <media rdaType="microform" rdaCode="h">rdamt:1002</media>
    <media rdaType="microscopic" rdaCode="p">rdamt:1004</media>
    <media rdaType="projected" rdaCode="g">rdamt:1005</media>
    <media rdaType="stereographic" rdaCode="e">rdamt:1006</media>
    <media rdaType="unmediated" rdaCode="n">rdamt:1007</media>
    <media rdaType="video" rdaCode="v">rdamt:1008</media>
  </xsl:variable>
  ...
  <xsl:variable name="resourceMap">
    ...
    <content resourceType="cartographic">cartographic tactile three-dimensional
      form</content>
    ...
    <content resourceType="sound recording-nonmusical">sound
      recording-nonmusical</content>
    ...
    <content resourceType="still image">art original</content>
    ...
    <content resourceType="still image">graphic</content>
    <content resourceType="still image">icon</content>
    ...
    <content resourceType="still image">painting</content>
    <content resourceType="still image">photograph</content>
    ...
    <content resourceType="still image">radiograph</content>
    ...
    <content resourceType="three dimensional object">tactile three-dimensional
      form</content>
  ...
  <xsl:variable name="marcLangList">
    ...
    <lang code="int" status="obsolete" use="ina">Interlingua (International Auxiliary
  ...
  <xsl:variable name="marcRelators">
    ...
    <relator term="editor of moving image work" code="edm" usefor="moving image work
      editor;"/>
    <relator term="electrician" code="elg" usefor="chief electrician;house
    ...
    <relator term="geographic information specialist" code="gis" usefor="geospatial
    ...
    <relator term="witness" code="wit"
      usefor="deponent;eyewitness;observer;onlooker;testifier;"/>
  ...
  <xsl:variable name="rightsMap">
    ...
    <statement text="CC BY-SA" url="https://creativecommons.org/licenses/by-sa/4.0/"/>
    <statement text="Attribution-ShareAlike 4.0"
      url="https://creativecommons.org/licenses/by-sa/4.0/"/>
    <statement text="Attribution 4.0" url="https://creativecommons.org/licenses/by/4.0/"/>
    <statement text="CC BY 4.0" url="https://creativecommons.org/licenses/by/4.0/"/>
  </xsl:variable>
  ...
  <!-- Default URI representation of usage rights -->
  <xsl:param name="useRightsURI" select="''"/>

  <!-- Name of external file containing PID / SIRSI catKey, preview, and usage rights info -->
  <xsl:param name="extraMetadataFile" select="''"/>

  <!-- Output represents a digital version of an analog original -->
  ...
  <xsl:template name="whereAmI">
    <xsl:choose>
      <xsl:when test="$reformattedDigital = 'true'">
      ...
      <xsl:when test="ancestor::*:relatedItem[matches(@type, 'constituent')]">
  ...
  <xsl:template name="makeAltTitle">
    ...
    <xsl:copy>
      ...
      <xsl:for-each
        ...
        <xsl:element xmlns="http://www.loc.gov/mods/v3" name="{$elementName}">
          <xsl:apply-templates
            select="@*[not(matches(local-name(), '(keyDate|qualifier)'))]" mode="prepMODS"/>
          <xsl:choose>
    ...
    <doc>
      ...
      <xsl:variable name="pass1">
            ...
            <xsl:when test="@nameTitleGroup">
              <field name="work_title">
                ...
                <xsl:variable name="name">
                  <xsl:for-each
                    select="..//*:name[@nameTitleGroup eq $thisNameTitleGroup]">
                ...
                <xsl:value-of
                  select="concat(replace(normalize-space($name), '\.$', ''), '. ')"/>
                <xsl:value-of
        ...
        <xsl:variable name="keyDate1">
          <xsl:choose>
            <xsl:when test="*:originInfo/*[@keyDate = 'yes']">
              <xsl:value-of
                select="replace(descendant::*[@keyDate = 'yes'][1], '[\[\{\}\]]', '')"/>
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateIssued">
              <xsl:value-of
                select="replace(descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateIssued[1], '[\[\{\}\]]', '')"
              />
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateCreated">
              <xsl:value-of
                select="replace(descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateCreated[1], '[\[\{\}\]]', '')"
              />
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:copyrightDate">
              <xsl:value-of
                select="replace(descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:copyrightDate[1], '[\[\{\}\]]', '')"
              />
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateValid">
              <xsl:value-of
                select="replace(descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateValid[1], '[\[\{\}\]]', '')"
              />
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateCaptured">
              <xsl:value-of
                select="replace(descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateCaptured[1], '[\[\{\}\]]', '')"
              />
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateModified">
              <xsl:value-of
                select="replace(descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateModified[1], '[\[\{\}\]]', '')"
              />
            </xsl:when>
            <xsl:when
              test="descendant::*:relatedItem[@type eq 'host']/*:originInfo/*:dateOther">
              <xsl:value-of
        ...
        <xsl:variable name="keyDate2">
          <xsl:choose>
            ...
            <xsl:when
              test="matches($keyDate1, '(/|\.\.)') and matches($keyDate1, '[\?~%]')">
            ...
            <xsl:when test="matches($keyDate1, '(/$|/\.\.$|/XXXX$)')">
              <xsl:value-of
                select="concat('[', substring-before($keyDate1, '/'), ' TO *]')"/>
            </xsl:when>
        ...
        <xsl:if
          ...
          <field name="displayTitle">
            ...
            <xsl:value-of
              select="normalize-space(replace($displayTitle, '([.:,;/])\.', '$1'))"/>
          </field>
        </xsl:if>
        ...
        <xsl:for-each select="*:titleInfo[matches(@type, 'abbreviated')]">
          <field name="abbreviatedTitle">
            <xsl:call-template name="makeAltTitle"/>
          </field>
        </xsl:for-each>
        <!-- Translated Title -->
        ...
        <!-- Identifiers -->
        <!-- OCLC Number in recordInfo -->
        <xsl:for-each
          select="*:recordInfo/*:recordIdentifier[matches(@source, 'oco?lc', 'i')]">
        ...
        <xsl:apply-templates
          select="*:abstract | *:accessCondition | *:classification | *:language | *:subject/*:cartographics | *:targetAudience"
          mode="uvaMAP"/>
        <!-- Sort location on shelfLocator -->
        <xsl:apply-templates select="*:location" mode="uvaMAP"/>
        <!-- Notes -->
        <xsl:apply-templates
          select="*:note[not(matches(@type, '59[1-9]')) and normalize-space(.) ne '']"
          mode="uvaMAP"/>
        <!-- Usage rights info -->
        <xsl:choose>
          <!-- Use rights statement for digital item in the input file -->
          <xsl:when
            test="*:relatedItem[@type = 'otherFormat' and *:location/*:url]/*:accessCondition[@type = 'use and reproduction']">
            <xsl:for-each
              select="*:relatedItem[@type = 'otherFormat' and *:location/*:url]/*:accessCondition[@type = 'use and reproduction']">
          ...
          <xsl:when test="normalize-space($useRightsURI) != ''">
            <field name="useRestrict">
              ...
              <xsl:choose>
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/InC/1.0/')"
                ...
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/InC-EDU/1.0/')"
                  >In Copyright - Educational Use Permitted</xsl:when>
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/InC-NC/1.0/')"
                  >In Copyright - Non-Commercial Use Permitted</xsl:when>
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/InC-RUU/1.0/')"
                  >In Copyright - Rights-holder(s) Unlocatable or
                  Unidentifiable</xsl:when>
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/NoC-CR/1.0/')"
                  >No Copyright - Contractual Restrictions</xsl:when>
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/NoC-NC/1.0/')"
                  >No Copyright - Non-Commercial Use Only</xsl:when>
                <xsl:when
                ...
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/NoC-US/1.0/')"
                  >No Copyright - United States</xsl:when>
                <xsl:when
                ...
                <xsl:when
                  test="matches($useRightsURI, 'http://rightsstatements.org/vocab/NKC/1.0/')"
            ...
            <xsl:for-each
              ...
              <xsl:if test="normalize-space(../*:rsUrl) ne ''">
                <field name="useRestrict">
                  ...
                  <xsl:choose>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/InC/1.0/')"
                      >In Copyright</xsl:when>
                    <xsl:when
                    ...
                    <xsl:when
                      ...
                      >In Copyright - Educational Use Permitted</xsl:when>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/InC-NC/1.0/')"
                      >In Copyright - Non-Commercial Use Permitted</xsl:when>
                    <xsl:when
                      ...
                      Unidentifiable</xsl:when>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/NoC-CR/1.0/')"
                      >No Copyright - Contractual Restrictions</xsl:when>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/NoC-NC/1.0/')"
                      >No Copyright - Non-Commercial Use Only</xsl:when>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/NoC-OKLR/1.0/')"
                      >No Copyright - Other Known Legal Restrictions</xsl:when>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/NoC-US/1.0/')"
                      >No Copyright - United States</xsl:when>
                    <xsl:when
                    ...
                    <xsl:when
                      ...
                      >Copyright Undetermined</xsl:when>
                    <xsl:when
                      test="matches(../*:rsUrl, 'http://rightsstatements.org/vocab/NKC/1.0/')"
                      >No Known Copyright</xsl:when>
                    <xsl:when
          ...
          <!-- Use rights statement in the input file for the analog resource -->
          <xsl:when
            test="*:accessCondition[matches(@type, 'use') and normalize-space(@valueURI) != '']">
            <field name="useRestrict">
              <xsl:copy-of select="*:accessCondition/@*[matches(local-name(), '')]"/>
              <!-- Map @valueURI to a human-readable value -->
              <xsl:choose>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/InC/1.0/')"
                  >In Copyright</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/InC-OW-EU/1.0/')"
                  >In Copyright - EU Orphan Work</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/InC-EDU/1.0/')"
                  >In Copyright - Educational Use Permitted</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/InC-NC/1.0/')"
                  >In Copyright - Non-Commercial Use Permitted</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/InC-RUU/1.0/')"
                  >In Copyright - Rights-holder(s) Unlocatable or
                  Unidentifiable</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/NoC-CR/1.0/')"
                  >No Copyright - Contractual Restrictions</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/NoC-NC/1.0/')"
                  >No Copyright - Non-Commercial Use Only</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/NoC-OKLR/1.0/')"
                  >No Copyright - Other Known Legal Restrictions</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/NoC-US/1.0/')"
                  >No Copyright - United States</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/CNE/1.0/')"
                  >Copyright Not Evaluated</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/UND/1.0/')"
                  >Copyright Undetermined</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'http://rightsstatements.org/vocab/NKC/1.0/')"
                  >No Known Copyright</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nd/4.0/legalcode')"
                  >Attribution</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nd/4.0/legalcode')"
                  >CC BY-ND</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nc/4.0/legalcode')"
                  >Attribution-NonCommercial</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nc/4.0/legalcode')"
                  >CC BY-NC</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode')"
                  >Attribution-NonCommercial-ShareAlike</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode')"
                  >CC BY-NC-SA</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nc-nd/4.0/legalcode')"
                  >Attribution-NonCommercial-NoDerivs</xsl:when>
                <xsl:when
                  test="matches(@valueURI, 'https://creativecommons.org/licenses/by-nc-nd/4.0/legalcode')"
                  >CC BY-NC-ND</xsl:when>
        ...
        <!-- Resource access -->
        <xsl:choose>
          <!-- Get URI from relatedItem -->
          <xsl:when test="*:relatedItem[@type = 'otherFormat']/*:location/*:url">
            <field name="uri" access="object in context">
              <xsl:value-of select="*:relatedItem[@type = 'otherFormat']/*:location/*:url"
              />
            </field>
          </xsl:when>
          <!-- Add URIs based on SIRSI catalog key -->
          <xsl:when
            test="*:recordInfo/*:recordIdentifier[@source = 'SIRSI']/text() and $reformattedDigital = 'true'">
            <!--<field name="uri" access="raw object">
              <xsl:value-of select="*:recordInfo/*:recordIdentifier[@source = 'SIRSI']"/>
            </field>-->
            <field name="uri" access="object in context">
              <xsl:value-of
                select="concat('https://search.lib.virginia.edu/sources/uva_library/items/', *:recordInfo/*:recordIdentifier[@source = 'SIRSI'])"
              />
            </field>
          </xsl:when>
          <!-- Add URIs based on $PID value -->
          <xsl:when test="normalize-space($PID) != ''">
            ...
            <field name="uri" access="object in context">
              <xsl:value-of
                select="concat('https://search.lib.virginia.edu/sources/uva_library/items/', $PID)"
              />
            </field>
          </xsl:when>
          <!-- Add PID-based URIs from external file -->
          <xsl:when
            test="doc-available($extraMetadataFile) and normalize-space($PID) != ''">
            <xsl:variable name="pidMatchExact">
              <xsl:value-of select="concat('^', normalize-space($PID), '$')"/>
            </xsl:variable>
            <xsl:for-each
        ...
        <xsl:choose>
          ...
          <!-- Add catKey-based 'preview' URI from external file -->
          <xsl:when test="doc-available($extraMetadataFile)">
            <xsl:variable name="catKey">
              <xsl:value-of
                select="normalize-space(//*:recordInfo/*:recordIdentifier[@source = 'SIRSI'][1])"
              />
            </xsl:variable>
            <xsl:for-each select="doc($extraMetadataFile)//*/*[*[1] = $catKey][1]">
              <field name="uri" access="preview">
                <xsl:value-of
                  select="doc($extraMetadataFile)//*/*[*[1] = $catKey][1]/*[2]"/>
              </field>
            </xsl:for-each>
          </xsl:when>
        </xsl:choose>
        ...
        <xsl:variable name="subjectGeographics">
          <xsl:for-each
            select="descendant::*[matches(local-name(), 'geographic|geographicCode')]">
            <xsl:sort/>
            <xsl:variable name="thisValue">
              <xsl:value-of select="normalize-space(.)"/>
            </xsl:variable>
        ...
        <xsl:variable name="subjectHierarchicals">
          <xsl:for-each select="descendant::*:subject/*:hierarchicalGeographic">
            ...
            <field name="subjectGeographic">
              ...
              <xsl:call-template name="copyAuthDisplayAttr2"/>
              <xsl:value-of
                select="normalize-space(string-join(*[normalize-space(.) ne ''], '--'))"/>
            </field>
          </xsl:for-each>
        </xsl:variable>
          ...
          <xsl:for-each select="descendant::*:subject/*:name">
            <field name="subjectName">
              ...
              <xsl:variable name="namePartSeparator">
                <xsl:choose>
                  <xsl:when
                    test="descendant::*[position() != last()][matches(., '[\.:,;/-]+$')]">
                    <xsl:text> </xsl:text>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:text>, </xsl:text>
        ...
        <!-- Relationships -->
        <xsl:apply-templates
          select="*:relatedItem[matches(@type, 'host|original|series')]" mode="uvaMAP"/>
        <xsl:apply-templates select="*:relatedItem[matches(@type, 'isReferencedBy')]"
          mode="uvaMAP"/>
        <xsl:apply-templates
          select="*:relatedItem[matches(@type, 'preceding|succeeding')]" mode="uvaMAP"/>
        <xsl:apply-templates
          select="*:relatedItem[matches(@type, 'otherFormat') and not(descendant::*:url)]"
          mode="uvaMAP"/>
        <xsl:apply-templates
          select="*:relatedItem[matches(@type, 'otherVersion') and not(descendant::*:url)]"
          mode="uvaMAP"/>
        <xsl:apply-templates select="*:relatedItem[matches(@type, 'constituent')]"
          mode="uvaMAP"/>
      ...
      <xsl:if test="not($pass1/*:field[@name = 'work_title'])">
        <field name="work_title" supplied="yes">
          ...
          <xsl:value-of
            select="upper-case(substring($pass1/*:field[@name eq 'title'], 1, 1))"/>
    ...
    <xsl:if test="*:namePart[not(normalize-space(.) eq '')]">
      <xsl:variable name="fieldName">
        ...
        <xsl:choose>
          ...
          <xsl:when test="*:role[*:roleTerm[matches(., '^(creator|cre)$')]]"
            >creator</xsl:when>
          ...
          <xsl:for-each select="*:role/*:roleTerm">
            ...
            <xsl:choose>
              ...
              <xsl:when test="$marcRelators//*:relator[@code = $thisValue]">
                <role>
                  <xsl:value-of
                    select="$marcRelators//*:relator[@code = $thisValue]/@term"/>
                </role>
              </xsl:when>
              <xsl:otherwise>
                <role>
  ...
  <xsl:template match="*:abstract" mode="uvaMAP">
    ...
    <field name="{$fieldName}">
      <xsl:apply-templates select="@displayLabel | @xlink:href" mode="uvaMAP"/>
      <xsl:if test="matches(., '\[source:')">
        <xsl:attribute name="source">
          <xsl:analyze-string select="normalize-space(.)" regex="\[source:([^\]]*)\]">
      ...
      <xsl:if test="matches(., '\[authority:')">
        <xsl:attribute name="authority">
          <xsl:analyze-string select="normalize-space(.)" regex="\[authority:([^\]]*)\]">
            <xsl:matching-substring>
              <xsl:value-of select="normalize-space(regex-group(1))"/>
            </xsl:matching-substring>
          </xsl:analyze-string>
  ...
  <xsl:template match="*:identifier" mode="uvaMAP">
    <xsl:variable name="fieldName">
      ...
      <xsl:choose>
        ...
        <xsl:when test="matches(@type, 'lccn', 'i')"
          >libraryCongressControlNumber</xsl:when>
        <xsl:when test="matches(@type, 'isbn', 'i')"
          >internationalStandardBookNumber</xsl:when>
        <xsl:when test="matches(@type, 'issn', 'i')"
          >internationalStandardSerialNumber</xsl:when>
        <xsl:when test="matches(@type, 'isrc', 'i')"
          >internationalStandardRecordingCode</xsl:when>
        <xsl:when test="matches(@type, 'upc', 'i')">universalProductCode</xsl:when>
        <xsl:when test="matches(@type, 'ismn', 'i')"
          >internationalStandardMusicNumber</xsl:when>
        <xsl:when test="matches(@type, 'ian', 'i')">internationalArticleNumber</xsl:when>
        <xsl:when test="matches(@type, 'sici', 'i')"
          >serialItemContributionIdentifier</xsl:when>
        <xsl:when test="matches(@type, 'strn', 'i')"
          >standardTechnicalReportNumber</xsl:when>
        <xsl:when
  ...
  <xsl:template match="*:note[not(matches(@type, 'uvax-'))]" mode="uvaMAP">
    ...
    <xsl:if test="not(matches(@type, 'private'))">
      <field name="{$whereAmI}{$fieldName}">
        ...
        <xsl:if
          test="@displayLabel and not(matches(@displayLabel, '^(local|staff)$', 'i'))">
    ...
    <xsl:variable name="places">
      <xsl:for-each select="*:place">
        ...
        <xsl:for-each select="*:placeTerm[not(matches(@type, 'code'))]">
          ...
          <xsl:choose>
            <!-- Replace s.l. with standard value -->
  ...
  <xsl:template match="*:physicalDescription" mode="uvaMAP">
    <!-- Media type -->
    <xsl:if test="$reformattedDigital = 'true'">
    ...
    <!-- Collect media types based on certain values of form -->
    <xsl:variable name="mappedMediaTypes">
      <xsl:choose>
        <xsl:when test="*:form[matches(@authority, 'rdamedia')]">
          <xsl:choose>
            <xsl:when
              test="matches(*:form[matches(@authority, 'rdamedia')], '(audio|computer|microform|microscopic|projected|stereographic|unmediated|unspecified|video)')">
              <field name="{$mediaTypeFieldName}">
                <xsl:value-of select="*:form[matches(@authority, 'rdamedia')]"/>
              </field>
            </xsl:when>
            <xsl:otherwise>
              <!-- Search marcMediaMap for possible translation -->
              <xsl:variable name="thisValue">
                <xsl:value-of select="lower-case(normalize-space(.))"/>
              </xsl:variable>
    ...
    <xsl:choose>
      <xsl:when test="$mappedMediaTypes/*:field">
        <xsl:for-each select="distinct-values($mappedMediaTypes/*:field)">
          <field name="{$mediaTypeFieldName}">
            <xsl:value-of select="."/>
          </field>
        </xsl:for-each>
    ...
    <xsl:variable name="mappedCarrierTypes">
      <xsl:choose>
        <xsl:when test="*:form[matches(@authority, 'rdacarrier')]">
          <!-- Search marcCarrierMap for possible translation -->
          <xsl:for-each select="*:form[matches(@authority, 'rdacarrier')]">
            <field name="{$carrierTypeFieldName}">
              <xsl:variable name="thisValue">
                <!-- Correct to singular form -->
                <xsl:value-of select="replace(lower-case(normalize-space(.)), 's$', '')"/>
              </xsl:variable>
    ...
    <xsl:choose>
      <xsl:when test="$mappedCarrierTypes/*:field">
        <xsl:for-each select="distinct-values($mappedCarrierTypes/*:field)">
          <field name="{$carrierTypeFieldName}">
            <xsl:value-of select="."/>
          </field>
        </xsl:for-each>
    ...
    <xsl:for-each select="*:extent">
      ...
      <field name="physExtent">
        ...
        <xsl:message select="concat('Regex: ', $unit)" />
    ...
    <xsl:for-each
      ...
      <field name="{$fieldName}">
        <xsl:copy-of select="@displayLabel"/>
        <xsl:choose>
          <!-- Correct erroneous 'surround sound' value -->
          <xsl:when
            test="matches($fieldName, 'playbackChannels', 'i') and matches(., 'surround', 'i')">
            <xsl:text>surround</xsl:text>
          </xsl:when>
          <!-- Correct Dolby values -->
          <xsl:when
            test="matches($fieldName, 'playbackSpecial', 'i') and matches(., 'Dolby', 'i')">
            <xsl:analyze-string select="." regex="Dolby(-[ABC]( encoded)?)?">
              <xsl:matching-substring>
                <xsl:value-of
                  select="replace(., '(-[ABC])( encoded)?', '$1 encoded', 'i')"/>
              </xsl:matching-substring>
            </xsl:analyze-string>
          </xsl:when>
          <xsl:when test="matches($fieldName, 'formOfComposition', 'i')">
            <xsl:value-of select="replace(lower-case(.), 'christian', 'Christian')"/>
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of select="."/>
          </xsl:otherwise>
    ...
    <xsl:if
      test="*:form[matches(@type, 'material|technique')] or *:note[matches(@type, '^uvax-') and not(matches(@type, 'accMatter|alphabetScript|brailleClass|brailleMusicFormat|colorContent|containsBibrefs|containsIndex|filmPresentationFormat|formOfComposition|illustrations|instrumentsVoicesCode|musicKey|musicParts|performanceMedium|physDimensions|playbackChannels|playbackSpecial|playingSpeed|playingTime|projection|relief|scoreFormat|soundContent|transpositionArrangement|videoFormat'))]">
      <xsl:variable name="fieldName">
        <xsl:call-template name="whereAmI"/>
      ...
      <field name="{$fieldName}">
        <xsl:variable name="sortedDetails">
          <xsl:for-each
            select="*:form[matches(@type, 'material|technique')] | *:note[matches(@type, '^uvax-') and not(matches(@type, 'accMatter|alphabetScript|brailleClass|brailleMusicFormat|colorContent|containsBibrefs|containsIndex|filmPresentationFormat|formOfComposition|illustrations|instrumentsVoicesCode|musicKey|musicParts|performanceMedium|physDimensions|playbackChannels|playbackSpecial|playingSpeed|playingTime|projection|relief|scoreFormat|soundContent|transpositionArrangement|videoFormat'))]">
        ...
        <xsl:variable name="resourceTypes">
          ...
          <xsl:for-each
            ...
            <resourceType>
              <xsl:choose>
                <xsl:when
                  test="matches(normalize-space(.), '^(application|font|multipart)')">
  ...
  <xsl:template match="*:relatedItem[matches(@type, 'isReferencedBy')]" mode="uvaMAP">
    ...
    <field name="{$fieldName}">
      <xsl:value-of
        select="string-join(descendant::text()[normalize-space(.) ne ''], ' ')"/>
    </field>
  </xsl:template>
  
  <xsl:template
    match="*:relatedItem[matches(@type, 'otherFormat|otherVersion') and not(descendant::*:url)]"
    mode="uvaMAP">
    <xsl:variable name="fieldName">
      <xsl:call-template name="whereAmI"/>
      <xsl:text>relatedMaterial</xsl:text>
    </xsl:variable>
    <field name="{$fieldName}">
      <xsl:choose>
        <xsl:when test="@otherType">
      ...
      <xsl:value-of select="*:titleInfo[1]"/>
    </field>
  </xsl:template>

  <!-- Preceding/suceeding entry -->
  <xsl:template match="*:relatedItem[matches(@type, 'preceding|succeeding')]"
    mode="uvaMAP">
      ...
      <xsl:when test="descendant::*:url">
        <xsl:for-each select="*:location">
          ...
          <xsl:for-each select="*:url">
            ...
            <xsl:for-each
              select="../../*:accessCondition[@type = 'restriction on access']">
  ...
  <xsl:template match="*:accessCondition" mode="uvaMAP">
    ...
    <field name="{$fieldName}">
      <xsl:copy-of select="@authority | @authorityURI | @valueURI"/>
      <xsl:if test="@displayLabel[not(matches(., 'local|staff', 'i'))]">
        <xsl:attribute name="displayLabel">
          <xsl:value-of select="normalize-space(@displayLabel)"/>
        </xsl:attribute>
  ...
  <xsl:template match="*:mods/*:location" mode="uvaMAP">
    <xsl:choose>
      ...
      <xsl:when test="*:holdingSimple">
        <xsl:variable name="countCopyInfo">
          <xsl:value-of select="count(*:holdingSimple/*:copyInformation)"/>
        </xsl:variable>
        <xsl:for-each select="*:holdingSimple/*:copyInformation">
          <!--<xsl:variable name="repositoryName">
            <xsl:call-template name="whereAmI"/>
          ...
          <xsl:variable name="groupValue">
            ...
            <xsl:value-of
              select="concat('C', count(preceding-sibling::*:copyInformation) + 1)"/>
          </xsl:variable>
          <!--<xsl:if
            test="matches(ancestor::*:location/@displayLabel, '^(uva|Viu|University of Virginia( Library)?)', 'i')">
            <!-\- Provide standarized name of holding institution -\->
          ...
          <xsl:for-each select="*:shelfLocator">
            ...
            <field name="{$fieldName}">
              ...
              <xsl:if test="../*:note[@type = 'call_number_sort']">
                <xsl:attribute name="sortType">
                  <xsl:value-of select="../*:note[@type = 'call_number_sort']"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:value-of select="normalize-space(.)"/>
            </field>
  ...
  <xsl:template match="*:recordInfo/*:recordOrigin">
    <field name="recordOrigin">
      <xsl:variable name="recordOriginText">
        ...
        <xsl:text> Converted to uvaMAP using </xsl:text>
        <xsl:value-of select="concat($progName, ' (v. ', $progVersion, ') on ')"/>
        <xsl:value-of select="format-date(current-date(), '[Y]-[M01]-[D01]')"/> at
          <xsl:value-of select="format-time(current-time(), '[h]:[m] [P]')"/>
      </xsl:variable>
